...
const uint8_t keymaps[][MATRIX_ROWS][MATRIX_COLS] PROGMEM = {
    ...
    /* Layer 1: Default Layer With SpaceMod
     * ,-----------------------------------------------------------.
     * |Esc|  1|  2|  3|  4|  5|  6|  7|  8|  9|  0|  -|  =|  \|  `|
     * |-----------------------------------------------------------|
     * |Tab  |  Q|  W|  E|  R|  T|  Y|  U|  I|  O|  P|  [|  ]|Backs|
    ...
    * |-----------------------------------------------------------|
    * |Tab  |   |   |   |   |   |MwL|MwU|McU|MwD|MwR|Wbk|Wfr|Alt-T|
    * |-----------------------------------------------------------|
    * |Contro|Acl0|Acl1|Acl2|  |  |Mb2|McL|McD|McR|Mb1|  |Return  |
    * |-----------------------------------------------------------|
    ...
    */
    ...
    KEYMAP(GRV, F1,  F2,  F3,  F4,  F5,  F6,  F7,  F8,  F9,  F10, F11, F12, INS, DEL, \
           TAB, NO,  NO,  NO,  NO,  NO,  WH_L,WH_U,MS_U,WH_D,WH_R,FN2, FN3, BSPC,     \
           LCTL,ACL0,ACL1,ACL2,  NO,  NO,  NO,  MS_L,MS_D,MS_R,FN1, NO,  ENT,           \
...
#endif
    [0]  = ACTION_LAYER_MOMENTARY(2),               // 0 HHKB layer-2
    [1]  = ACTION_LAYER_TAP_KEY(3, KC_SCLN),        // 1 MouseKey layer with Semicolon
    [2]  = ACTION_MODS_KEY(MOD_LALT, KC_LEFT),      // 2 Walk back
    [3]  = ACTION_MODS_KEY(MOD_LALT, KC_RIGHT),     // 3 Walk forward
    [4]  = ACTION_MODS_TAP_KEY(MOD_LSFT, KC_SPACE), // 4 Spance and shift
    [5]  = ACTION_LAYER_TOGGLE(1),                  // 5 Toggle layer-1
